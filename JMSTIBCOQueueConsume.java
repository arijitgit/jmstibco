...
public class JMSTIBCOQueueConsume {
	...
	public static void main(String[] args) throws JMSException {
		//JMSTIBCOQueueConsume.sendQueueMessage("DM.ENTERPRISE.VISION.TEST","Arijit");
		JMSTIBCOQueueConsume.retrieveQueueMessage("DM.ENTERPRISE.VISION.TEST");
	}
}